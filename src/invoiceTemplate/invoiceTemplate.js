  ...
  `
    ...
    <body bgcolor="white" style="margin: 0;padding: 0;height: 100%;width: 100%!important;
                    ...
                    padding-top: 40px; max-width: 700px;display: block; ">
                        <table style="width: 100%;color: #666; border-bottom: 1px solid #333;">
                            <tr>
                                ...
                                <td align="right">
                                    <span
                                    style="color: #3E3F42; font-size: 14px;line-height: 28px; font-weight: 600">
        CLIENT</span>
        </td>
        </tr>
        ...
        max-width: 700px;display: block;">
                                        <table style="width: 100%;color: #666">
                                            <tr>
                                                <td style="padding: 5px 10px;">
                                                    <span
                                        style="color: rgba(62, 63, 66, 0.5);font-size: 12px;line-height: 18px;">
                                                        DATE/TIME</span>
                                                </td>
                                                <td align="right" style="padding: 5px 1;">
                                                ...
                                                <td style="padding: 5px 10px;">
                                                    ...
                                                    font-size: 12px;line-height: 18px;">FULL
                                                        NAME</span>
                                                </td>
                                                <td align="right" style="padding: 5px 10px;">
                                                    <span style="color: #3E3F42;font-size: 12px;
                                                    line-height: 22px;">${`${clientName}`}</span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="padding: 5px 10px;">
                                                    <span style="color: rgba(62, 63, 66, 0.5);
                                                    font-size: 12px;line-height: 18px;">DELIVERY
                                                        DATE</span>
                                                </td>
                                                <td align="right" style="padding: 5px 10px;">
                                                    <span style="color: #3E3F42;font-size: 12px;;
                                                    line-height: 22px;">${`${deliveryDate}`}</span>
                                                </td>
    
                                                <td style="padding: 5px 10px;">
                                                    <span
                                                    style="color: rgba(62, 63, 66, 0.5);
                                                    font-size: 12px;line-height: 18px;">EMAIL</span>
                                                </td>
                                                <td align="right" style="padding: 5px 10px;">
                                                    <span style="color: #3E3F42;font-size: 12px;;
                                                    line-height: 22px;">${`${email}`}</span>
                                                </td>
                                            </tr>
                                ...
                                <td align="right" style="padding: 5px 10px;">
                                    <span style="color: #3E3F42;font-size: 12px;;
                                    line-height: 22px;">${`${address || 'N/A'}`}</span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align="right" style="padding: 5px 10px;">
                                    <span style="color: #3E3F42;font-size: 12px;;
                                    line-height: 22px;">${`${paymentType || 'N/A'}`}</span>
                                </td>
                    ...
                    padding-top: 60px; max-width: 700px;display: block; ">
                                        <table style="width: 100%;color: #666;border-collapse: collapse;">
                                            <thead>
                                                <tr>
                                                    <th style="padding:5px; color: rgba(62, 63, 66, 0.5);
    ...
    return `
                    ...
                    padding-top: 30px; max-width: 700px;display: block; ">
                                        <table style="width: 100%;color: #666;">
                                            <tr>
                                                <td align="right">
                                                    <span style="color: #3E3F42; font-size: 18px;
    ...
    font-size: 12px; line-height: 18px; color: #3E3F42;">
                                        ...
                                        font-size:10px;line-height:16px;max-width: 335px;
